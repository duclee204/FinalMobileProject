...
const SearchFlower3 = ({ navigation }) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState('Hồng Ngoại Thương');
  ...
  const categoryScreens = {
    'Hàng mới': 'SearchFlower1',
    'Hoa hồng Đà Lạt': 'SearchFlower2',
    'Hồng Ngoại Thương': 'SearchFlower3',
    'Hoa Hồng Cổ': 'SearchFlower4', // Update to the correct screen name if needed
  };

  const handleCategoryPress = (category) => {
    setSelectedCategory(category);
    navigation.navigate(categoryScreens[category]);
  };
